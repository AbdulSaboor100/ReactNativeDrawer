                ...
                state.approvedApplication ? (
                    state.approvedApplication.status === "approved" ? (
                        ...
                        <View>
                            ...
                            <View>
                                <Text>Father Name : {state.approvedApplication.rejectObj.fatherName}</Text>
                            </View>
                            <View>
                                <Text>Cnic No : {state.approvedApplication.rejectObj.cnic}</Text>
                            </View>
                            <View>
                                <Text>Contact No : 92-311-1729526</Text>
                            </View>
                            <View>
                                <Text>Food Bank Branch Name</Text>
                                <Text>{state.approvedApplication.rejectObj.nearestOne.name}</Text>
                            </View>
                        </View>
                    )
                ) : (
